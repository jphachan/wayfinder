...
public class MainOptionTab1 extends Activity {
	...
	//Perform initialization for the first interface CheckBox
		...
		//assign the first button to a variable
		final RadioGroup rg = (RadioGroup) findViewById(R.id.auton_bar);
		final RadioButton rb1 = (RadioButton) findViewById(R.id.auton_radio_1);
		final RadioButton rb2 = (RadioButton) findViewById(R.id.auton_radio_2);
		final RadioButton rb3 = (RadioButton) findViewById(R.id.auton_radio_3);
