		...
		GoButton1A.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if(FromSpin.getSelectedItemPosition() == 0){
					...
					Intent intent = new Intent(android.content.Intent.ACTION_VIEW, Uri.parse("http://maps.google.com/maps?saddr=" + location[FromSpin.getSelectedItemPosition()].latitude + "," + location[FromSpin.getSelectedItemPosition()].longitude + "&daddr=" + location[destSpin.getSelectedItemPosition()].latitude + "," + location[destSpin.getSelectedItemPosition()].longitude));
