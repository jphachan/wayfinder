		...
		GoButton1A.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if(FromSpin.getSelectedItemPosition() == 0){
					...
					Intent intent = new Intent(android.content.Intent.ACTION_VIEW, Uri.parse("http://maps.google.com/maps?saddr=" + findLatLngByCode(FromSpin.getSelectedItemPosition(), 1).latitude + "," + findLatLngByCode(FromSpin.getSelectedItemPosition(), 1).longitude + "&daddr=" + findLatLngByCode(destSpin.getSelectedItemPosition(), 0).latitude + "," + findLatLngByCode(destSpin.getSelectedItemPosition(), 0).longitude + "&mode=w"));
