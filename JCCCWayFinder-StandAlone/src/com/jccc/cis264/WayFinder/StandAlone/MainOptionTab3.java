...
public class MainOptionTab3 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final RadioGroup rg = (RadioGroup) findViewById(R.id.auton_bar2);
		final RadioButton defaultrb = (RadioButton) findViewById(R.id.auton_radio_5);
		final RadioButton rb2 = (RadioButton) findViewById(R.id.auton_radio_4);
		final RadioButton rb3 = (RadioButton) findViewById(R.id.auton_radio_6);
			...
			ShowMeAMap.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					//if no course is selected
						...
						if(rg.getCheckedRadioButtonId() == defaultrb.getId()){
							Map.putExtra("type", "sat");
						}
						else if(rg.getCheckedRadioButtonId() == rb2.getId()){
							Map.putExtra("type", "map");
						}
						else if(rg.getCheckedRadioButtonId() == rb3.getId()){
							Map.putExtra("type", "hyb");
						}
						
						System.out.println(Destinations);
						
						Map.putStringArrayListExtra("Points", Destinations);
